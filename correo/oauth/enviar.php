...
if($op == 0){
$mensaje = "https://practica-galeria-arte-mariangeles94.c9users.io/usuario/phpmensaje.php?email=$destino&activo=$semilla";
}else{
        $mensaje = "https://practica-galeria-arte-mariangeles94.c9users.io/usuario/nuevaclave.php?email=$destino&activo=$semilla" ;
}
